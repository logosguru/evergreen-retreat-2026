...
여기서 double/single은 **침대 개수**다 (double=침대 2개, single=침대 1개).
리조트 기준 대부분의 방이 double이고, 필요한 만큼만 single로 신청한다.
...
| bed_type 의미 | **침대 개수** — single=침대 1개, double=침대 2개 (침대 크기 아님). 리조트 기준 대부분 double, 일부만 single 신청. 화면 라벨에 개수 병기 (예: "더블(침대 2개)") |
